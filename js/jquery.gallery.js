	...
	$.Gallery.prototype 	= {
		...
		_layout				: function() {
			...
			if( this.support3d && this.supportTrans ) {
				...
				leftCSS 	= {
					'-webkit-transform'	: 'translateX(-350px) translateZ(-400px) rotateY(0deg)',
					'-moz-transform'	: 'translateX(-350px) translateZ(-400px) rotateY(0deg)',
					'-o-transform'		: 'translateX(-350px) translateZ(-400px) rotateY(0deg)',
					'-ms-transform'		: 'translateX(-350px) translateZ(-400px) rotateY(0deg)',
					'transform'			: 'translateX(-350px) translateZ(-400px) rotateY(0deg)'
				};
